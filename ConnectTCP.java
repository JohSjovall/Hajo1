...
public class ConnectTCP {
    ...
    /**
    * Luo portti listan Y palvelusta saadusta luvusta. Portien luvut luodaan randomisti ja porttien lukumäärä vaihtelee 2-10
    * Jos saatu luku ei ole 2-10 väliltä. Lähetetään Y plavelimelle arvo -1 ja asetetaan "running"-arvoksi false
    *
    * @return int[]
    * @throws Exception
    */
    ...
    */
    ...
    /**
    * Muodostaa UDP-yhteyden palvelimeen Y ja lähettää paketin, joka sisältää X:n portin 
    *
    * @throws IOException
    */
